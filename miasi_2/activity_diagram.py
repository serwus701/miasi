...
def parse_xml_to_svg(xml_file, svg_file):
    try:
        ...
        for activity in diagrams.findall(".//Activity"):
            ...
            wrapped_lines = wrap_text(name, width - 10)
        ...
        for action in diagrams.findall(".//ActivityAction"):
            ...
            text_len = width / 20
            wrapped_lines = wrap_text(name, int(text_len))
        ...
        for final_node in diagrams.findall(".//ActivityFinalNode"):
            ...
            dwg.add(dwg.circle(center=(x + 2 * radiuss, y + radiuss), r=radiuss, **final_node_style))
            final_nodes_count += 1

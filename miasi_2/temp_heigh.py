...
def parse_xml_to_svg(xml_file, svg_file):
    ...
    decision_node_style = {'stroke': 'black', 'fill': 'rgb(122, 207, 245)', 'stroke-width': 2}  # Style for DecisionNode
    object_node_style = {'stroke': 'black', 'fill': 'rgb(122, 207, 245)', 'stroke-width': 2}  # Style for ObjectNode
    ...
    for activity in diagrams.findall(".//Activity"):
        ...
        height = float(activity.get('Height', '50'))  # Default height
    ...
    for action in diagrams.findall(".//ActivityAction"):
        ...
        height = float(action.get('Height', '50'))  # Default height
    ...
    for accept_event in diagrams.findall(".//AcceptEventAction"):
        ...
        height = float(accept_event.get('Height', '50'))  # Default height
    ...
    for send_signal in diagrams.findall(".//SendSignalAction"):
        ...
        height = float(send_signal.get('Height', '50'))  # Default height
